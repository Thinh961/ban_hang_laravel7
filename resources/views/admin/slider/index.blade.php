...
<div id="content" class="container-fluid">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            @can('admin.slider.action')
            <div class="analytic">
                <a href="{{ Route('admin.slider.index') }}" class="text-primary">Tất cả<span class="text-muted">({{
                        $count[0] }})</span></a>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Thứ tự</th>
                             @canany(['admin.slider.edit', 'admin.slider.destroy'])
